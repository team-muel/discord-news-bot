...
5. `docs/planning/PROGRESSIVE_AUTONOMY_30D_CHECKLIST.md`
6. `docs/planning/GO_NO_GO_GATE_TEMPLATE.md`
7. `docs/planning/AUTONOMY_CONTRACT_SCHEMAS.json`
...
4. Evidence-first incident logging:
