...
const TRAFFIC_ROUTING_SHADOW_DIVERGE_THRESHOLD = parseBoundedNumberEnv(process.env.TRAFFIC_ROUTING_SHADOW_DIVERGE_THRESHOLD, 0.3, 0, 1);
const TRAFFIC_ROUTING_QUALITY_DELTA_THRESHOLD = parseBoundedNumberEnv(process.env.TRAFFIC_ROUTING_QUALITY_DELTA_THRESHOLD, -0.2, -1, 0);
