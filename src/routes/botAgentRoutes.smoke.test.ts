...
describe('bot agent route module smoke', () => {
  it('registers representative endpoints from all domains', () => {
    ...
    expect(routeKeys.has('GET /agent/runtime/supabase/extensions')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/supabase/hypopg/evaluate')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/efficiency')).toBe(true);
    expect(routeKeys.has('PUT /agent/runtime/channel-routing')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/sandbox-policy-sync')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/self-improvement/cross-loop')).toBe(true);
    ...
    expect(routeKeys.has('GET /agent/runtime/loops')).toBe(true);
    ...
    expect(routeKeys.has('GET /agent/runtime/readiness')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/slo/report')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/slo/alerts')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/slo/evaluate')).toBe(true);
    expect(routeKeys.has('GET /agent/finops/summary')).toBe(true);
    expect(routeKeys.has('GET /agent/finops/showback')).toBe(true);
    expect(routeKeys.has('GET /agent/finops/budget')).toBe(true);
    expect(routeKeys.has('GET /agent/llm/experiments/summary')).toBe(true);
    ...
    expect(routeKeys.has('POST /agent/runtime/openjarvis/memory-sync/managed')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/openjarvis/scheduler')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/openjarvis/memory-sync/schedule')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/openjarvis/scheduler/start')).toBe(true);
    expect(routeKeys.has('GET /agent/runtime/hermes/vscode-bridge')).toBe(true);
    expect(routeKeys.has('POST /agent/runtime/hermes/vscode-bridge')).toBe(true);
